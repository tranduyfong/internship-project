...
router.put('/:id', verifyToken, requirePermission('EDIT_PRODUCT'), productController.editProduct);
router.patch('/:id/status', verifyToken, requirePermission('DELETE_PRODUCT'), productController.changeStatus);
router.get('/admin', verifyToken, requirePermission('VIEW_PRODUCT'), productController.getAdminList);
